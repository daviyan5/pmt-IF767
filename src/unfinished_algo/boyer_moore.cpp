...
vector<int> good_suffix_bf(char *pat){
    int m = strlen(pat);
...
vector<int> good_suffix(char *pat){
    int m = strlen(pat);
...
vector<int> boyer_moore(char *txt, char *pat, char *alphabet, vector<int>&bc = NULL, vector<int>&gs = NULL){
    vector<int> occ;
    int n = strlen(txt);
    int m = strlen(pat);
